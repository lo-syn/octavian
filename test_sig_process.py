...
windowed_burst = SineBurst(1000, -2, 1, 48000, windowed=True)
...
audio_slicer(windowed_burst, 0, 0.55)
...
audio_amplify_dbfs(windowed_burst, 3)
...
audio_parameter_calc(windowed_burst, True)
...
audio_fft_convert(windowed_burst, True, "test_windowed_sine_fft")
...
audio_export(windowed_burst, "test_windowed_sine_export")
...
audio_envelope_follower(windowed_burst, 1024, 512)
