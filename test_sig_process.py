...
audio_file = AudioFile(r"C:\Users\laure\OneDrive\Documents\Octavian\4AM.wav")
...
audio_file = audio_slicer(audio_file, 0, 0.1)
...
plt.plot(audio_file.fft_freqs, audio_file.fft_db, color='p')
plt.title('FFT')
